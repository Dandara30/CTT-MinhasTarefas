...
class BottomSheetEditarTarefa(
    val dadosTarefa : Tarefa,
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        val titulo = view.findViewById<EditText>(R.id.etTituloTarefa)
        val descricao = view.findViewById<EditText>(R.id.etDescricaoTarefa)
        titulo.setText(dadosTarefa.titulo.toString())
        descricao.setText(dadosTarefa.descricao.toString())


        val btVoltar = view.findViewById<ImageButton>(R.id.btVoltar)
        ...
        btSalvarTarefa.setOnClickListener{
            ...
            val idTarefa = view.findViewById<TextView>(R.id.idTarefa)
            val statusTarefa = view.findViewById<TextView>(R.id.statusTarefa)
            val titulo = view.findViewById<EditText>(R.id.etTituloTarefa)
            val descricao = view.findViewById<EditText>(R.id.etDescricaoTarefa)



            var id = idTarefa.toString().toLongOrNull()
            if (id == null) { id = 0 }

            val novaTarefa = TarefaEntity(id,
                titulo.text.toString(),
                descricao.text.toString(),
                statusTarefa.toString())

            bottomSheetViewModel = ViewModelProviders.of(this).get(BottomSheetViewModel::class.java)
            bottomSheetViewModel.editarTarefa(novaTarefa)
