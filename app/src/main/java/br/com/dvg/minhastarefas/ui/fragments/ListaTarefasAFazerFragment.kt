...
import br.com.dvg.minhastarefas.ui.bottomsheet.BottomSheetNovaTarefa
import com.google.android.material.floatingactionbutton.ExtendedFloatingActionButton

class ListaTarefasAFazerFragment: Fragment(), DialogClickListener {
    ...
    private fun inicializaTarefaAFazer() {
        val listaTarefas: MutableList<Tarefa> = mutableListOf()
        listaTarefaViewModel = ViewModelProviders.of(this).get(ListaTarefaViewModel::class.java)
        listaTarefaViewModel.getTarefasAFazerObservers().observe(viewLifecycleOwner, Observer {
...
//        listaTarefas.add(Tarefa(10, "Teste1", "Descricao 1", StatusTarefa.AFAZER))
//        listaTarefas.add(Tarefa(11, "Teste2", "Descricao 2", StatusTarefa.AFAZER))
//        listaTarefas.add(Tarefa(12, "Teste3", "Descricao 3", StatusTarefa.AFAZER))
//        listaTarefas.add(Tarefa(13, "Teste4", "Descricao 4", StatusTarefa.AFAZER))
//        listaTarefas.add(Tarefa(14, "Teste5", "Descricao 5", StatusTarefa.AFAZER))
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        fabAdicionar.visibility = View.VISIBLE

        //Ação do botão adicionar (BottomSheetDialog)
        fabAdicionar.setOnClickListener{

            val bottomSheetNovaTarefa = BottomSheetNovaTarefa()
            bottomSheetNovaTarefa.show(childFragmentManager, "TAG")
    ...
    private fun carregarMensagemListaVazia() {
        ...
        msgListaVazia.text = resources.getString(R.string.msg_vazia_afazer)
    }
