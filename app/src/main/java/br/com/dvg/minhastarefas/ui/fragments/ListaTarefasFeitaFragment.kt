...
class ListaTarefasFeitaFragment: Fragment(), DialogClickListener {
    ...
    private fun inicializaTarefaFeita() {
        val listaTarefas: MutableList<Tarefa> = mutableListOf()
        listaTarefaViewModel = ViewModelProviders.of(this).get(ListaTarefaViewModel::class.java)
        listaTarefaViewModel.getTarefasFeitasObservers().observe(viewLifecycleOwner, Observer {
...
//        listaTarefas.add(Tarefa(10, "Teste1", "Descricao 1", StatusTarefa.FEITA))
//        listaTarefas.add(Tarefa(11, "Teste2", "Descricao 2", StatusTarefa.FEITA))
//        listaTarefas.add(Tarefa(12, "Teste3", "Descricao 3", StatusTarefa.FEITA))
//        listaTarefas.add(Tarefa(13, "Teste4", "Descricao 4", StatusTarefa.FEITA))
//        listaTarefas.add(Tarefa(14, "Teste5", "Descricao 5", StatusTarefa.FEITA))
    }
